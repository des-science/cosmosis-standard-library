...
# !NOTE: Default files are not real data!!! 
default_data_file = os.path.join(os.path.split(__file__)[0], "DESONLY_hubble_diagram.txt")
default_covmat_file = os.path.join(os.path.split(__file__)[0], "DESONLY_covsys_000.txt")
